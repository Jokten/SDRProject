...
class qpsk_stage6_ss_xmt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_stage6_ss_xmt")
...
def main(top_block_cls=qpsk_stage6_ss_xmt, options=None):
